...
[![Tests](https://img.shields.io/badge/tests-27%2F27%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 27/27 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 27/27 controls — families below, ~20 s on a laptop
```
