...
[![Tests](https://img.shields.io/badge/tests-23%2F23%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 23/23 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 23/23 controls — families below, ~20 s on a laptop
```
