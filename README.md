...
[![Tests](https://img.shields.io/badge/tests-28%2F28%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 28/28 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 28/28 controls — families below, ~20 s on a laptop
```
