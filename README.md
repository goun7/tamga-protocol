...
[![Tests](https://img.shields.io/badge/tests-34%2F34%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 34/34 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 34/34 controls — families below, ~20 s on a laptop
```
