...
[![Tests](https://img.shields.io/badge/tests-33%2F33%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 33/33 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 33/33 controls — families below, ~20 s on a laptop
```
