...
[![Tests](https://img.shields.io/badge/tests-22%2F22%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 22/22 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 22/22 controls — families below, ~20 s on a laptop
```
