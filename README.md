...
[![Tests](https://img.shields.io/badge/tests-32%2F32%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 32/32 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 32/32 controls — families below, ~20 s on a laptop
```
