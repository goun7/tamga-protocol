...
[![Reproduce](https://img.shields.io/badge/docs-reproduce%20it%20yourself-blue)](docs/REPRODUCE.md) — last full suite run: 2026-09-11
...
bash tests/run_all.sh          # 43/43 controls — ~20 s (46 with RUN_SLOW=1)
...
```bash
bash tests/run_all.sh        # 43/43 controls — families below, ~20 s on a laptop (46 with RUN_SLOW=1)
```
