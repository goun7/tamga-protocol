...
[![Tests](https://img.shields.io/badge/tests-26%2F26%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 26/26 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 26/26 controls — families below, ~20 s on a laptop
```
