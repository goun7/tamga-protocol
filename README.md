...
[![Tests](https://img.shields.io/badge/tests-25%2F25%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 25/25 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 25/25 controls — families below, ~20 s on a laptop
```
