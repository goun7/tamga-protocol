...
[![Tests](https://img.shields.io/badge/tests-30%2F30%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 30/30 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 30/30 controls — families below, ~20 s on a laptop
```
