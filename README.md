...
[![Tests](https://img.shields.io/badge/tests-29%2F29%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 29/29 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 29/29 controls — families below, ~20 s on a laptop
```
