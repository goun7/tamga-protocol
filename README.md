...
[![Tests](https://img.shields.io/badge/tests-24%2F24%20PASS-brightgreen)](#one-command-regression)
...
bash tests/run_all.sh          # 24/24 controls — ~20 s
...
```bash
bash tests/run_all.sh        # 24/24 controls — families below, ~20 s on a laptop
```
