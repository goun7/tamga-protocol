...
- **Overhead taban çizgisi (2026-09-05, E-4):** koşum-dışı op yükleri ölçüldü (kanit/BENCH/2026-09-05/runner-overhead.json): medyan grant=152ms · ledger-verify=73ms · memory-search=70ms · export=182ms (scrypt baskın) · import=72ms. Yöntem notu: yüklü ortamda mutlak değer değil **op-arası oran** anlamlı; Faz 2'de sessiz host'ta tekrarlanıp "overhead < X% koşum" beyanı bu tabanla yapılır.
