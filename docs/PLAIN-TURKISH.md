...
snapshot. Status: working prototype, simulation only (no real money), 83-control fast /
88-control slow acceptance suite, two external-verification tracks live on the x402
