...
snapshot. Status: working prototype, simulation only (no real money), 49-control fast /
53-control slow acceptance suite, two external-verification tracks live on the x402
