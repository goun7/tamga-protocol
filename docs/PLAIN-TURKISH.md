...
snapshot. Status: working prototype, simulation only (no real money), 48-control fast /
52-control slow acceptance suite, two external-verification tracks live on the x402
