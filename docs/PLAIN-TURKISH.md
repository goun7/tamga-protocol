...
snapshot. Status: working prototype, simulation only (no real money), 81-control fast /
86-control slow acceptance suite, two external-verification tracks live on the x402
