...
snapshot. Status: working prototype, simulation only (no real money), 47-control fast /
51-control slow acceptance suite, two external-verification tracks live on the x402
