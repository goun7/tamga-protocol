...
Last verified from the published wheel (**0.2.10**, live PyPI): **2026-09-16** —
...
Expected tail: `RESULT: 52 PASS, 0 FAIL` (57 with `RUN_SLOW=1`). Last verified here: **2026-09-16** on **0.2.10**: full suite re-proved on HEAD (56/56 slow, idle machine), and the published wheel was
