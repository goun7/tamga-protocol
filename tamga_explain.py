...
Kök-modül (2026-09-11): `tamga explain <...>` CLI-bu-modüle-bağlanır; tools/explain.py
uyumluluk-alias'ıdır (repo-checkout-yolçapları-AT-016/verify_lite-aynen-çalışır).

Usage:
  python3 tamga_explain.py <receipt.json>            # dx402-receipt veya charge-kaydı (TR)
  python3 tamga_explain.py --en <receipt.json>       # English rendering
  python3 tamga_explain.py --charge <ledger.jsonl> 2  # zincir-N-kayıt (TR)
  tamga explain <receipt.json>                       # kurulumdan-sonra (bootstrap)
"""
