...
Kök-modül kopyası (wheel-yüzeyi): tools/keccak256.py ile bayt-bayt aynı algoritma;
tools/ repo-checkout içindir, bu kopya yayınlanan wheel'le gider (RFC-007 R2
--delivery-alg keccak256 yolu wheel'de de çözülür; 2026-09-11 bulgusu: _digest
tools/ yolunu çözüyordu — kurulumda kırılırdı)."""
