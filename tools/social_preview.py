#!/usr/bin/env python3
"""GitHub social-preview görseli — 1280×640 (GitHub'ın önerdiği 2:1).
SVG banner'la aynı dil: koyu-lacivert zemin, mühür+zincir motifi, altın→gök-mavisi vurgu."""
...
# üç ayak
y = 440
for t in ["Taşınabilir kimlik", "Şifreli hafıza", "Doğrulanabilir iş-makbuzu"]:
    d.ellipse([tx, y+9, tx+12, y+21], fill=(232, 163, 61))
    d.text((tx+26, y), t, font=f_bodyB, fill=(203, 213, 225))
    y += 44
# durum-şeridi
d.text((tx, 580), "Faz 2 · pilot · Apache-2.0 · kanıt-kültürü", font=f_body, fill=(148, 163, 184))
